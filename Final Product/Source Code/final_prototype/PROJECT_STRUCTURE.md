...
| File / Folder | Origin | Description |
|---------------|--------|-------------|
...
| `config/device_profiles/` | N/A | Folder for holding PlusToolkit device condiguration files. Inputs that are maintained and reused across sessions.
